...
const MainSliderThing  = (props) =>{
        ...
        style={{width: '100%', height: '500px'}} alt="Fourth slide"/>
...
<h2>{props.text2}</h2>
            ...
            let indicard = [];
            let card = [];
            card.push(<MainSliderThing active="item active" image={data['slider0'].image} text1={data['slider0'].text1} text2={data['slider0'].text2}/>);
            ...
            for(var i=1;i<count;i++){
                ...
                card.push(<MainSliderThing active="item" image={data[name].image} text1={data[name].text1} text2={data[name].text2}/>);
